...
especie(arya, gato).
especie(naveen, gato).
especie(meg, cachorro).
especie(koda, cachorro).
especie(nina, cachorro).

% genero(nome, genero)
genero(clarissa, feminino).
genero(bruna, feminino).
